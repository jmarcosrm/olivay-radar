    ...
    <div className={cn("absolute inset-0 overflow-hidden pointer-events-none", className)}>
      ...
      <div 
        className={cn(
          ...
          variant === "dark" ? "bg-olive-mid-1/25" : "bg-gold-soft-1/20"
        )}
      ...
      >
        <div 
          className={cn(
            ...
            variant === "dark" 
              ? "bg-gradient-to-r from-gold-soft-1/40 to-transparent" 
              : "bg-gradient-to-r from-gold-soft-2/50 to-transparent"
          )}
        />
      </div>
      ...
      <div 
        className={cn(
          ...
          variant === "dark" ? "bg-gold-soft-1/70" : "bg-gold-soft-2/90"
        )}
        style={{
          top: "35%",
          left: "60%",
          boxShadow: variant === "dark" 
            ? "0 0 16px hsl(43 61% 60% / 0.6)" 
            : "0 0 16px hsl(44 64% 65% / 0.7)",
        }}
      />
      ...
      <div 
        className={cn(
          ...
          variant === "dark" ? "bg-gold-soft-1/50" : "bg-gold-soft-2/70"
        )}
        style={{
          top: "55%",
          left: "35%",
          animationDelay: "1s",
          boxShadow: variant === "dark" 
            ? "0 0 12px hsl(43 61% 60% / 0.4)" 
            : "0 0 12px hsl(44 64% 65% / 0.5)",
        }}
      />
      ...
      <div 
        className={cn(
          ...
          variant === "dark" ? "bg-gold-soft-1/40" : "bg-gold-soft-2/60"
        )}
        style={{
          top: "25%",
          left: "40%",
          animationDelay: "2s",
          boxShadow: variant === "dark" 
            ? "0 0 8px hsl(43 61% 60% / 0.3)" 
            : "0 0 8px hsl(44 64% 65% / 0.4)",
        }}
      />
    </div>
  );
